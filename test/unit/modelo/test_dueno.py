...
class TestDueno(unittest.TestCase):
    ...
    def test_registrar_dueno_ok(self):
        ...
        self.assertEqual("Sol", d.get_nombre())
    ...
    def test_registrar_dueno_dni_string(self):
        with self.assertRaises(TypeError):
            self.clinica.registrar_dueno("abc", "Sol", "01136111111", "Calle")

    def test_registrar_dueno_dni_invalido(self):
        with self.assertRaises(ValueError):
            self.clinica.registrar_dueno(123, "Sol", "01136111111", "Calle")
    ...
    def test_registrar_dueno_nombre_numerico(self):
        with self.assertRaises(ValueError):
            self.clinica.registrar_dueno(47111111, "5", "01136111111", "Calle")

    def test_registrar_dueno_telefono_string(self):
        with self.assertRaises(ValueError):
            self.clinica.registrar_dueno(47111111, "Sol", "abc", "Calle")

    def test_registrar_dueno_telefono_corto(self):
        with self.assertRaises(ValueError):
            self.clinica.registrar_dueno(47111111, "Sol", "123", "Calle")

    def test_registrar_dueno_direccion_vacia(self):
        with self.assertRaises(ValueError):
            self.clinica.registrar_dueno(47111111, "Sol", "01136111111", "")

    def test_registrar_dueno_duplicado(self):
        self.clinica.registrar_dueno(47111111, "Sol", "01136111111", "Calle")

        with self.assertRaises(ValueError):
            self.clinica.registrar_dueno(
                47111111,
                "Ro",
                "01136111111",
                "Calle"
